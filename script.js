...
const temperature = document.querySelector('.temperature_div_section');
const weatherDescription = document.querySelector('.weather-description_div_section');
const city = document.querySelector('.city_div_section');
const icon_wind = document.querySelector('.icon-wind');
const icon_humidity = document.querySelector('.icon_humidity');
const wind_speed = document.querySelector('.wind-speed');
const weather_description = document.querySelector('.weather-description_div_section');
...
async function getWeather() {
        ...
        if (data.name == name) {
            ...
            if (nothing) {
                ...
                error_text.textContent = 'Простите, пожалуйста! Попытка получения сведений о погоде оказалась неуспешной!';
            }
            console.log(nothing);
        }
}
...
function showTime() {
      ...
      time.innerHTML = `${hour}<span>:</span>${addZeros(min)}<span>:</span>${addZeros(sec)}<br> `;
...
function setBgGreet() {
  ...
  if (hour >= 6 && hour < 12) {
    ...
    switch (hour) {
          case 6:
              document.body.style.backgroundImage = "url(./images/07.jpg)";
              document.body.style.color = "white";
            break;
          case 7:
              document.body.style.backgroundImage = "url(./images/08.jpg)";
              document.body.style.color = 'black';
            break;
          case 8:
              document.body.style.backgroundImage = "url(./images/09.jpg)";
              document.body.style.color = "white";
            break;
          case 9:
    ...
    switch (hour) {
          ...
          case 15:
            ...
            break;
          case 16:
              document.body.style.backgroundImage = "url(./images/17.jpg)";
              document.body.style.color = 'white';
            break;
          case 17:
              document.body.style.backgroundImage = "url(./images/18.jpg)";
              document.body.style.color = 'black';
            break;
    }
    ...
    switch (hour) {
          case 18:
              document.body.style.backgroundImage = "url(./images/19.jpg)";
              document.body.style.color = 'white';
            break;
          case 19:
              document.body.style.backgroundImage = "url(./images/20.jpg)";
              document.body.style.color = "black";
            break;
          case 20:
            ...
            break;
          case 21:
              document.body.style.backgroundImage = "url(./images/22.jpg)";
              document.body.style.color = "black";
            break;
          case 22:
              document.body.style.backgroundImage = "url(./images/23.jpg)";
              document.body.style.color = 'white';
            break;
          case 23:
    ...
    switch (hour) {
          ...
          case 4:
            ...
            break;
          case 5:
              document.body.style.backgroundImage = "url(./images/06.jpg)";
              document.body.style.color = 'white';
            break;
    }
  }
